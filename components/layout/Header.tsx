    ...
    >
      <div className="mx-auto flex h-[72px] max-w-[1240px] items-center gap-6 px-5 sm:px-6 lg:h-20 lg:px-8">
        ...
        <nav className="hidden flex-1 items-center justify-center gap-7 lg:flex xl:gap-9">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="hover:text-clay text-[15px] font-medium transition-colors"
            >
              {link.label}
            </Link>
          ))}
        ...
        <div className="ml-auto flex items-center gap-4 lg:ml-0 lg:gap-6">
          <a
            href={site.phoneHref}
            className="hover:text-clay hidden items-center gap-2 text-[15px] font-semibold transition-colors md:inline-flex"
          >
            <PhoneIcon />
            {site.phone}
          </a>
